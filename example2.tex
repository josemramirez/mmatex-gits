...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.75\textwidth]{phase_space_trajectories.pdf}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.75\textwidth]{temperature_profile.pdf}
