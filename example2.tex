...
These results demonstrate that incorporating dual-metric behavioral response significantly improves model predictions compared to traditional approaches \\cite{wang2015coupled}, while maintaining computational tractability \\cite{funk2010modelling}.\end{document}