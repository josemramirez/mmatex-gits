...
where $v$ is the advanced time coordinate. The event horizon is located at $r_h = 2GM/c^2$. Our analysis focuses on null geodesics near this horizon, described by the geodesic equation: \begin{equation}x^2 \mathcal{M} \tilde{\rho }^{\frac{\gamma +1}{2}}=\lambda \label{Mi ecuacion 8} \end{equation}\frac{d^2x^}{\mu}{d\lambda^2} + \Gamma^{\mu}_{\alpha\beta}\frac{dx^}{\alpha}{d\lambda}\frac{dx^}{\beta}{d\lambda} = 0\end{document}