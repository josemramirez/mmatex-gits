...
where $\kappa$ is the surface gravity, related to the Hawking temperature by $T = \hbar\kappa/(2\pi k_B)$. \begin{equation}x^2 \mathcal{M} \tilde{\rho }^{\frac{\gamma +1}{2}}=\lambda \label{Mi ecuacion 8} \end{equation}\end{document}